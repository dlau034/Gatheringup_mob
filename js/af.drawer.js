/**
 * af.web.drawer - a drawer for App Framework apps
 ...
 */ (function ($) {
    ...
    var drawer = (function () {
        ...
        var translateOpen=$.feat.cssTransformStart,translateClose=$.feat.cssTransformEnd,touchStarted = false;
        ...
        var drawer = function (elID, opts) {
                ...
                try {
                    ...
                    if (!this.handle) return alert("Could not find handle for drawer -  " + this.el.id);
                    var that = this;
        ...
        drawer.prototype = {
            ...
            touchStart: function (event) {
                ...
                try {
                    ...
                    this.maxTop = numOnly($(this.el).computedStyle("height")) - numOnly($(this.handle).computedStyle("height"));
                    this.maxLeft = numOnly($(this.el).computedStyle("width")) - numOnly($(this.handle).computedStyle("width"));
